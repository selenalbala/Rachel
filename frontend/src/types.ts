...
export type Product={id:string;imageData?:string|null;name:string;brand?:string|null;category?:string|null;supplier?:string|null;unit:ProductUnit;quantity:string|number;minimum:string|number;cost:string|number;price:string|number;notes?:string|null;active:boolean};
